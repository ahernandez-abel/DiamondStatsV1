...
function AdminBillingPage() {
  ...
  const whatsappUrl = `https://wa.me/${paymentInfo?.whatsapp}?text=${whatsappText}`;
    ...
    <DashboardLayout>
      <section className="admin-billing-page">
        <div className="admin-billing-header">
          ...
          <p>
            Revisa el plan actual de tu equipo y solicita actualización cuando lo necesites.
          </p>
        </div>
        ...
        <div className="admin-billing-card">
          ...
          <div className="admin-billing-features">
            <p>
              ...
              Estadísticas avanzadas: {billing?.allow_advanced_stats ? 'Sí' : 'No'}
            </p>

            <p>
              <CheckCircle2 size={18} />
              Comparar jugadores: {billing?.allow_player_compare ? 'Sí' : 'No'}
            </p>

            <p>
              <CheckCircle2 size={18} />
              Logo personalizado: {billing?.allow_custom_logo ? 'Sí' : 'No'}
            </p>
          </div>

          {billing?.plan_slug !== 'pro' && (
            <a
              href={whatsappUrl}
              target="_blank"
              rel="noreferrer"
